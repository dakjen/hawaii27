...
export const ITINERARY = [
  ...
  { id:'gj-ogg-las', party:'gj', type:'flight', date:'2027-01-23',
    title:'OGG → LAS', subtitle:'Gina & John', location:'Las Vegas',
    detail:'Planned, not booked. Off Maui on checkout day, into Vegas — same window Ben & Dakotah are there.' },
  { id:'gj-las-bwi', party:'gj', type:'flight', date:'2027-01-24',
    title:'LAS → BWI', subtitle:'Gina & John', location:'Baltimore',
    detail:'Planned, not booked. Home from Vegas — date not confirmed.' },
...
export const DAY_GRID = {
  ...
  gj: {
    ...
    '2027-01-24': { where: 'BWI', move: 'LAS → BWI' },
  },
  kelly: {
    '2027-01-16': { where: 'OGG', move: 'LGB → OGG' },
    '2027-01-17': { where: 'OGG' },
