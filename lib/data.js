...
export const ITINERARY = [
  ...
  { id:'bd-nyc-lax', party:'bd', type:'flight', date:'2027-01-14',
    title:'LGA → LAX', subtitle:'Ben & Dakotah · AA 4411 + 814 · 3:10pm · via PIT', location:'Los Angeles',
    booked:true, departureUtc:'2027-01-14T20:10:00Z',
    detail:'LaGuardia 3:10pm → LAX 8:26pm, 8h 16m via Pittsburgh. AA 4411 LGA–PIT on an Embraer 170 (Republic as American Eagle), then AA 814 PIT–LAX on a 737 MAX 8. 7,000 AAdvantage miles + $5.60 each. Overnight in LA before the Maui hop.' },
  ...
  { id:'myron-vegas', party:'bd', parties:['bd','gj'], type:'note', date:'2027-01-25',
    title:'Myron is in Las Vegas', subtitle:'Mon 25 Jan', location:'Las Vegas',
    detail:'Heads up — Myron will be in Vegas on the 25th. Ben & Dakotah fly home that day; Gina & John are at Caesars until the 26th.' },
  ...
  // Kelly
  { id:'kelly-bwi-lax', party:'kelly', type:'flight', date:'2027-01-15',
    title:'BWI → LAX', subtitle:'Kelly · 8:37am · non-stop', location:'Los Angeles',
    detail:'Planned, not booked. Baltimore 8:37am → LAX 11:39am, non-stop. 15,000 miles. Lands before noon, leaving the afternoon free before the 7:35am out of Long Beach — LGB is about 20 miles from LAX.' },
...
export const DAY_GRID = {
  ...
  kelly: {
    '2027-01-15': { where: 'LAX', move: 'BWI → LAX' },
...
export const BOOKINGS = [
  ...
  },
  {
    ...
    title: 'LGA → LAX',
    guests: 'Ben & Dakotah',
    room: 'AA 4411 + AA 814 via Pittsburgh, Main Cabin',
    location: 'Los Angeles',
    date: '2027-01-14',
    program: 'AAdvantage',
    cash: 11.20,
    points: 14000,
    cashValue: 1604,
    note: '7,000 miles + $5.60 per person, two people. Main Cabin on the same itinerary now prices at $802 per person — the fare has climbed a long way since this was booked.',
  },
  {
    id: 'bd-hyatt',
    party: 'bd',
  ...
  },
  {
    ...
    points: 0,
    cashValue: 587.52,
    note: 'Booked. Kahului Airport, pick up Fri 15 Jan at noon, back Fri 22 Jan at noon. 7 days. The one car for the whole group.',
  },
  {
    id: 'gj-lax-ogg',
    party: 'gj',
  ...
  },
  {
    ...
    points: 37000,
    cashValue: 243.03,
    note: '37,000 Bonvoy points plus $23.20 in taxes. Cash rate for the same night is $243.03 all in — $189 room plus $54.03 taxes and fees.',
  },
].sort((a, b) => {
  const byDate = (a.date || '').localeCompare(b.date || '');
  if (byDate) return byDate;
